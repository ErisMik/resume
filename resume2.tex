...
\section{Programming Skills}
 \resumeSubHeadingListStart
    \skillsSubheading {Languages}
      \resumeItemListStart
        \resumeItem{Fluent} {C, C++, Java, Python, Javascript, Bash, HTML/CSS}
        \resumeItem{Proficient} {Ruby/Rails, Assembly, Verilog, Wiring, Rust}
        \resumeItem{Familiar} {iOS (Swift), Android (Java), MySQL}
      \resumeItemListEnd

    \skillsSubheading {Technologies}
      \resumeItemListStart
        \resumeItem{Frameworks \& Libraries} {Django, Rails (Ruby), Terraform}
        \resumeItem{Tools} {Yocto, Jenkins, AWS}
      \resumeItemListEnd
...
\section{Clubs \& Design Teams}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{UBC Baja Team}
      {Suspension Subteam, microcontroller sensor project; 2016 -> 2017}
  \resumeSubHeadingListEnd
