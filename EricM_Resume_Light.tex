...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{} {Created the C++ wrappers and EJS templates to add the C++ language version of the Zaber Motion Library. This includes the setup of CI build, packaging and deployment for the finished library on multiple OSes and architectures.}
        \resumeItem{} {Implemented core Go library functionality for the Zaber Motion Library. This included ASCII and binary protocol features and behaviour required to release the library.}
      \resumeItemListEnd
...
\section{Qualifications}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Canadian Pilot Certificate}{Small Remotely Piloted Aircraft System; Achieved 2019}
  \resumeSubHeadingListEnd

%%% Awards %%%
\section{Awards}
  \resumeSubHeadingListStart
    \resumeSubItem{Winner}
      {NW Hacks 2019, University of British Columbia; Achieved 2019}
