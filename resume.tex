...
\location{Fluent:}
C \textbullet{}   C++ \textbullet{} Java \textbullet{} Python/Django \\
Javascript \textbullet{} Bash Shell \\ 
\location{Proficient:}
...
\begin{tightemize}
\bigskip
\item Created automated docs website publishing pipeline with Terraform and Jenkins pipeline
